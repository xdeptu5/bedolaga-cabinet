...
/** Вкладки как в оригинале bsbord.com: хосты панели, IP / домен, скан CIDR, VPN-тест, GEO — и история проверок. */
...
describe('ModeSwitch', () => {
  it('шесть вкладок, активная отмечена, клик отдаёт вкладку наверх', () => {
